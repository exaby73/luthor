...
$ExternalUserCopyWith<ExternalUser> get copyWith => _$ExternalUserCopyWithImpl<ExternalUser>(this as ExternalUser, _$identity);
...
abstract mixin class $ExternalUserCopyWith<$Res>  {
  factory $ExternalUserCopyWith(ExternalUser value, $Res Function(ExternalUser) _then) = _$ExternalUserCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$ExternalUserCopyWithImpl<$Res>
...
/// Adds pattern-matching-related methods to [ExternalUser].
extension ExternalUserPatterns on ExternalUser {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ExternalUser value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ExternalUser() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ExternalUser value)  $default,){
final _that = this;
switch (_that) {
case _ExternalUser():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ExternalUser value)?  $default,){
final _that = this;
switch (_that) {
case _ExternalUser() when $default != null:
return $default(_that);case _:
...
class _ExternalUser implements ExternalUser {
  ...
  factory _ExternalUser.fromJson(Map<String, dynamic> json) => _$ExternalUserFromJson(json);
...
@pragma('vm:prefer-inline')
_$ExternalUserCopyWith<_ExternalUser> get copyWith => __$ExternalUserCopyWithImpl<_ExternalUser>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ExternalUserToJson(this, );
}
...
/// @nodoc
abstract mixin class _$ExternalUserCopyWith<$Res> implements $ExternalUserCopyWith<$Res> {
  factory _$ExternalUserCopyWith(_ExternalUser value, $Res Function(_ExternalUser) _then) = __$ExternalUserCopyWithImpl;
@override @useResult
$Res call({
 String name, String email, int? age
});
...
mixin _$UserProfile {
 ...
 int get id; ExternalUser get user; ExternalUser? get user2; List<ExternalUser>? get friends; List<String> get tags; DateTime get createdAt; DateTime? get updatedAt;
...
@useResult
$Res call({
 int id, ExternalUser user, ExternalUser? user2, List<ExternalUser>? friends, List<String> tags, DateTime createdAt, DateTime? updatedAt
});


$ExternalUserCopyWith<$Res> get user;$ExternalUserCopyWith<$Res>? get user2;
...
as ExternalUser?,friends: freezed == friends ? _self.friends : friends // ignore: cast_nullable_to_non_nullable
as List<ExternalUser>?,tags: null == tags ? _self.tags : tags // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  ExternalUser user,  ExternalUser? user2,  List<ExternalUser>? friends,  List<String> tags,  DateTime createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserProfile() when $default != null:
return $default(_that.id,_that.user,_that.user2,_that.friends,_that.tags,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  ExternalUser user,  ExternalUser? user2,  List<ExternalUser>? friends,  List<String> tags,  DateTime createdAt,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _UserProfile():
return $default(_that.id,_that.user,_that.user2,_that.friends,_that.tags,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  ExternalUser user,  ExternalUser? user2,  List<ExternalUser>? friends,  List<String> tags,  DateTime createdAt,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _UserProfile() when $default != null:
return $default(_that.id,_that.user,_that.user2,_that.friends,_that.tags,_that.createdAt,_that.updatedAt);case _:
  return null;
...
@override final  ExternalUser user;
@override final  ExternalUser? user2;
 final  List<ExternalUser>? _friends;
@override List<ExternalUser>? get friends {
...
@override $ExternalUserCopyWith<$Res> get user;@override $ExternalUserCopyWith<$Res>? get user2;
...
/// Create a copy of UserProfile
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? user = null,Object? user2 = freezed,Object? friends = freezed,Object? tags = null,Object? createdAt = null,Object? updatedAt = freezed,}) {
  return _then(_UserProfile(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,user: null == user ? _self.user : user // ignore: cast_nullable_to_non_nullable
as ExternalUser,user2: freezed == user2 ? _self.user2 : user2 // ignore: cast_nullable_to_non_nullable
as ExternalUser?,friends: freezed == friends ? _self._friends : friends // ignore: cast_nullable_to_non_nullable
as List<ExternalUser>?,tags: null == tags ? _self._tags : tags // ignore: cast_nullable_to_non_nullable
as List<String>,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,updatedAt: freezed == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
