...
mixin _$ClassicClassFreezed {
  ...
  $ClassicClassFreezedCopyWith<ClassicClassFreezed> get copyWith =>
      _$ClassicClassFreezedCopyWithImpl<ClassicClassFreezed>(
          this as ClassicClassFreezed, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ClassicClassFreezed &&
...
abstract mixin class $ClassicClassFreezedCopyWith<$Res> {
  factory $ClassicClassFreezedCopyWith(
          ClassicClassFreezed value, $Res Function(ClassicClassFreezed) _then) =
      _$ClassicClassFreezedCopyWithImpl;
  @useResult
  $Res call({@HasMin(3) String name, int age});
}
