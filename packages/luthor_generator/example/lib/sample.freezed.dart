...
@override
String toString() {
  return 'Sample(anyValue: $anyValue, boolValue: $boolValue, doubleValue: $doubleValue, intValue: $intValue, listValue: $listValue, numValue: $numValue, stringValue: $stringValue, email: $email, date: $date, dateTime: $dateTime, exactly10Characters: $exactly10Characters, minAndMaxString: $minAndMaxString, startsWithFoo: $startsWithFoo, endsWithBar: $endsWithBar, containsBaz: $containsBaz, minAndMaxInt: $minAndMaxInt, minAndMaxDouble: $minAndMaxDouble, minAndMaxNumber: $minAndMaxNumber, httpsLink: $httpsLink, aUrl: $aUrl, luthorPath: $luthorPath, uuid: $uuid, cuid: $cuid, cuid2: $cuid2, emoji: $emoji, anotherSample: $anotherSample, foo: $foo, custom: $custom, numbers: $numbers, hello: $hello)';
}
...
switch (_that) {
case _Sample() when $default != null:
return $default(_that.anyValue,_that.boolValue,_that.doubleValue,_that.intValue,_that.listValue,_that.numValue,_that.stringValue,_that.email,_that.date,_that.dateTime,_that.exactly10Characters,_that.minAndMaxString,_that.startsWithFoo,_that.endsWithBar,_that.containsBaz,_that.minAndMaxInt,_that.minAndMaxDouble,_that.minAndMaxNumber,_that.httpsLink,_that.aUrl,_that.luthorPath,_that.uuid,_that.cuid,_that.cuid2,_that.emoji,_that.anotherSample,_that.foo,_that.custom,_that.numbers,_that.hello);case _:
  return orElse();
...
@override@isCuid final  String cuid;
@override@isCuid2 final  String cuid2;
@override@isEmoji final  String emoji;
