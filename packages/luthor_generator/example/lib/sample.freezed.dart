...
// Null? nullValue,
 num get numValue; String get stringValue;@isEmail String get email;@isDateTime String get date; DateTime get dateTime;@HasLength(10) String? get exactly10Characters;@HasMin(8)@HasMax(200) String get minAndMaxString;@StartsWith('foo') String get startsWithFoo;@EndsWith('bar') String get endsWithBar;@Contains('baz') String get containsBaz;@HasMin(2)@HasMax(4) int get minAndMaxInt;@HasMinDouble(2.0)@HasMaxDouble(4.0) double get minAndMaxDouble;@HasMinNumber(2)@HasMaxNumber(3.0) num get minAndMaxNumber;@IsUri(allowedSchemes: ['https']) String? get httpsLink;@IsUrl() String? get aUrl;@MatchRegex(r'^https:\/\/pub\.dev\/packages\/luthor') String get luthorPath; AnotherSample get anotherSample;@JsonKey(name: 'jsonKeyName') String get foo;@WithCustomValidator(customValidatorFn) String get custom; List<int> get numbers; String? get hello;
...
class _Sample implements Sample {
  const _Sample({this.anyValue, required this.boolValue, required this.doubleValue, required this.intValue, required final  List<String> listValue, required this.numValue, required this.stringValue, @isEmail required this.email, @isDateTime required this.date, required this.dateTime, @HasLength(10) this.exactly10Characters, @HasMin(8)@HasMax(200) required this.minAndMaxString, @StartsWith('foo') required this.startsWithFoo, @EndsWith('bar') required this.endsWithBar, @Contains('baz') required this.containsBaz, @HasMin(2)@HasMax(4) required this.minAndMaxInt, @HasMinDouble(2.0)@HasMaxDouble(4.0) required this.minAndMaxDouble, @HasMinNumber(2)@HasMaxNumber(3.0) required this.minAndMaxNumber, @IsUri(allowedSchemes: ['https']) this.httpsLink, @IsUrl() this.aUrl, @MatchRegex(r'^https:\/\/pub\.dev\/packages\/luthor') required this.luthorPath, required this.anotherSample, @JsonKey(name: 'jsonKeyName') required this.foo, @WithCustomValidator(customValidatorFn) required this.custom, required final  List<int> numbers, this.hello}): _listValue = listValue,_numbers = numbers;
...
@override@HasLength(10) final  String? exactly10Characters;
...
@override@MatchRegex(r'^https:\/\/pub\.dev\/packages\/luthor') final  String luthorPath;
@override final  AnotherSample anotherSample;
@override@JsonKey(name: 'jsonKeyName') final  String foo;
@override@WithCustomValidator(customValidatorFn) final  String custom;
