...
Validator $SampleSchema = l.withName('Sample').schema({
  ...
  SampleSchemaKeys.email: l.string().email().required(),
  SampleSchemaKeys.date: l.string().dateTime().required(),
  SampleSchemaKeys.dateTime: l.string().dateTime().required(),
  SampleSchemaKeys.exactly10Characters: l.string().length(10),
  ...
  SampleSchemaKeys.custom: l.string().custom(customValidatorFn).required(),
